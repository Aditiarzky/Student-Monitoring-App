...
<button data-drawer-target="sidebar-multi-level-sidebar" data-drawer-toggle="sidebar-multi-level-sidebar" aria-controls="sidebar-multi-level-sidebar" type="button" class="inline-flex items-center p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg sm:hidden  focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-blue-600  dark:focus:ring-gray-600">
 ...
 <aside id="sidebar-multi-level-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full overflow-y-auto bg-blue-400">
       ...
       <ul class="space-y-2 mx-3 my-4 font-medium">
          <li>
             <a href="/admin" class="flex items-center p-2 rounded-lg text-white  hover:bg-blue-600  group">
          ...
          <li>
             <a href="/admin/pengumuman" class="flex items-center p-2 rounded-lg text-white  bg-blue-600  group">
 ...
 <div class="sm:ml-64">
    ...
    <div class="mt-5">
        <div class="mb-5">
            <a class="text-white cursor-pointer text-lg font-normal px-4 py-[5px] bg-blue-600 rounded-[3px] ml-10">Tambah Pengumuman</a>
        </div>
    <h1 class="text-xl ml-10 font-normal">Daftar Pengumuman</h1>
   </div>
            ...
            <div class="relative w-full overflow-auto">
                <table class="w-full caption-bottom text-sm">
                    ...
                    <tbody class="[&amp;_tr:last-child]:border-0">
                        <tr class="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
                            <td class="p-4 align-middle [&amp;:has([role=checkbox])]:pr-0">Cuti Bersama</td>
                            <td class="p-4 align-middle [&amp;:has([role=checkbox])]:pr-0">12 Dec 2023</td>
                            <td class="p-4 align-middle [&amp;:has([role=checkbox])]:pr-0"><div class="max-h-20 overflow-y-auto">
                                Dengan penuh sukacita, kami umumkan bahwasanya cuti bersama akan dilaksanakan pada tanggal [tanggal mulai] hingga [tanggal akhir].

                                Selama masa cuti bersama, kegiatan belajar mengajar diliburkan. Siswa dan orang tua/wali dapat memanfaatkan kesempatan ini untuk beristirahat, refreshing, dan tentunya merayakan pencapaian semester ini.
                            </div></td>
                            <td class="p-4 align-middle [&amp;:has([role=checkbox])]:pr-0">
                                <div class="justify-start items-start inline-flex">
                                    <a class="w-[50px] cursor-pointer text-center text-blue-600 text-sm font-normal">Edit</a>
                                    <a class="w-[50px] cursor-pointer text-center text-red-600 text-sm font-normal">Hapus</a>
                                </div>
                            </td>
                        </tr>
                        <tr class="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
                            <td class="p-4 align-middle [&amp;:has([role=checkbox])]:pr-0">Pengambilan Raport</td>
                            <td class="p-4 align-middle [&amp;:has([role=checkbox])]:pr-0">15 Jan 2024</td>
                            <td class="p-4 align-middle [&amp;:has([role=checkbox])]:pr-0">
                                <div class="max-h-20 overflow-y-auto">
                                    Dengan ini, kami sampaikan informasi bahwa pengambilan raport siswa akan dilaksanakan pada tanggal [tanggal raport].

                                    Silakan datang ke sekolah untuk mengambil raport anak Anda. Raport ini mencakup prestasi dan perkembangan belajar siswa selama semester ini.
