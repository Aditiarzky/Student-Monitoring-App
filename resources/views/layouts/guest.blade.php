...
<body class="font-sans text-gray-900 overflow-x-hidden bg-gray-100 antialiased">
    <div class="min-h-screen mb-20 flex flex-col justify-center items-center pt-6 p-2 sm:pt-0 ">
        <div>
                <div class="w-[422px] h-[416px] px-[68.14px] py-[84.07px] justify-center items-center inline-flex">
                    <img src="https://images2.imgbox.com/d7/08/yT7f0mv4_o.png" class="w-[285.73px] h-[247.87px] relative flex-col justify-start items-start flex"></img>
                </div>
        </div>
