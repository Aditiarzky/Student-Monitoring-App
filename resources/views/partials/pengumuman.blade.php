    ...
    <div class="w-full animate-fade-in sm:max-w-md m-2 sm:m-0 px-2 py-3 overflow-hidden rounded-lg">
        ...
        <section class="mt-4">
            ...
            <div class="flex items-center justify-between mb-5">
                <div class="text-gray-200 text-lg font-medium">Pengumuman</div>
            </div>
            <div class="w-full bg-gradient-to-br from-gray-800 to-gray-700 text-white rounded-lg p-4 border border-white border-opacity-50 transition duration-300 ease-in-out transform flex flex-col justify-start items-start gap-1 mt-2">
                <details>
                    ...
                    <p class="text-xs mt-2 mb-3 text-gray-300">
