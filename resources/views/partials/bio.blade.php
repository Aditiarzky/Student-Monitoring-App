    ...
    <div class="w-full animate-fade-in sm:max-w-md m-2 sm:m-0 px-2 py-3 overflow-hidden rounded-lg h-full">
        ...
        <section class="mt-4">
            <div class="flex items-center justify-between mt-2 mb-5">
                <div class="text-slate-800 text-lg font-medium">Biodata Siswa</div>
            </div>
            <!-- Biodata Siswa -->
            <div class="w-full bg-sky-200  text-slate-800 rounded-lg p-4 border-1 border-white border-opacity-50 transition duration-300 ease-in-out transform flex flex-col justify-start items-start gap-1 mt-2 border">
                <div class="flex mb-4 last:mb-0">
                    ...
                    <dd class="whitespace-pre-wrap break-words support-break-word s13-regular-white leading-16 flex-1 text-sm">Nama Lengkap Siswa</dd>
                </div>
                <div class="flex mb-4 last:mb-0">
            ...
            <div class="flex items-center justify-between mt-2 mb-2">
                <div class="text-slate-800 text-lg font-medium">Biodata Orang Tua</div>
            </div>
            <div class="w-full bg-sky-200 text-slate-800 rounded-lg p-4 border-1 border-white border-opacity-50 transition duration-300 ease-in-out transform flex flex-col justify-start items-start gap-1 mt-2 border">
                <div class="flex mb-4 last:mb-0">
